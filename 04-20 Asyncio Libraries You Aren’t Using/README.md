...
۵. چهار بایت اول را بگیرید. این همان پیشوندِ اندازه است.
۶. این 4 بایت باید به عدد (integer) تبدیل شوند
۷. حال ما اندازه پیام را می‌دانیم، پس به همان اندازه از استریم می‌خوانیم
۸. عملیات نوشتن برعکس عملیات خواندن است: ابتدا طول داده با رمزگذاری 4 بایتی، و سپس داده را ارسال می‌کنیم.
...
۳. <p dir="rtl"> <code>Datebase</code> یک instance از Connection به ما ارائه کرده است، که بلافاصله برای ساخت یک جدول جدید در دیتابیس با نام users استفاده می‌شود.</p>
